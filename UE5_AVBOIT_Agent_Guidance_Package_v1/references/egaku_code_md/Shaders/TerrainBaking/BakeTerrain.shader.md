# Egaku source: `Shaders/TerrainBaking/BakeTerrain.shader`
    ...
    HLSLINCLUDE
     	...
     	float4 frag_RefineGradientMap(Varyings v2f) : SV_Target
        {
            ...
            if (IsZeroGradient(gradient.rg)||IsClipped(gradient)){
                ...
                float4 nearestGradient = GetNearestGradient(_MainTex, sampler_MainTex, uv, deltaUV, 512,nearestGradientDist,averageGradient);
