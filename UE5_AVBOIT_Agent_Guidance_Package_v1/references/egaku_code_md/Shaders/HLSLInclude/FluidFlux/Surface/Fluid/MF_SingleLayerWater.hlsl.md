# Egaku source: `Shaders/HLSLInclude/FluidFlux/Surface/Fluid/MF_SingleLayerWater.hlsl`
...
MF_SingleLayerWater_Attributes MF_SingleLayerWater(float FoamScattering, float WaveScattering, float Painter, float Shoreline)
{
    ...
    MF_SingleLayerWater_Attributes ZERO_INITIALIZE(MF_SingleLayerWater_Attributes, OutputAttributes);
