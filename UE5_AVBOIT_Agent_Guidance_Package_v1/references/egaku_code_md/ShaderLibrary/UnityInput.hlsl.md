# Egaku source: `ShaderLibrary/UnityInput.hlsl`
...
// ----------------------------------------------------------------------------
// Unity specified macro definitions, copied from com.unity.render-pipelines.universal@14.0.12/ShaderLibrary/Input.hlsl
...
// ----------------------------------------------------------------------------
// Following codes are copied from com.unity.render-pipelines.universal@14.0.12/ShaderLibrary/UnityInput.hlsl
...
#endif // UNITY_INPUT_HLSL_INCLUDED
```
