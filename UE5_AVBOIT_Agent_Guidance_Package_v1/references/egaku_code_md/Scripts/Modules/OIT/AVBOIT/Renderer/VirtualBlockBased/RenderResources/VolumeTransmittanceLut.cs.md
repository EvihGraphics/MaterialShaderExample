# Egaku source: `Scripts/Modules/OIT/AVBOIT/Renderer/VirtualBlockBased/RenderResources/VolumeTransmittanceLut.cs`
...
namespace Modules.OIT.AVBOIT.Renderer.VirtualBlockBased.RenderResources {
    public struct VolumeTransmittanceLut {
        ...
        public void Setup(int width,int height,int sliceCount) { 
            ...
            RenderingUtils.ReAllocateIfNeeded(
                ...
                name: $"AVBOIT - Volume Transmittance Lut"
            );
        }
