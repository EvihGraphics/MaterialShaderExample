# Egaku source: `Scripts/Modules/Sky/Cloud/Volumetric/Renderer/RenderResources/SunTransmittanceLut.cs`
...
namespace Modules.Sky.Cloud.Volumetric.Renderer.RenderResources {
    public struct SunTransmittanceLut {
        ...
        public void Setup(int width,int height,int sliceCount) { 
            ...
            RenderingUtils.ReAllocateIfNeeded(
                ...
                name: $"VolumetricCloud - Sun Transmittance Lut"
            );
        }
