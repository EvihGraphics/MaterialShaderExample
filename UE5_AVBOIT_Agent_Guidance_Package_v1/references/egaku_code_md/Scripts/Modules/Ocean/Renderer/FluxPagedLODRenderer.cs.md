# Egaku source: `Scripts/Modules/Ocean/Renderer/FluxPagedLODRenderer.cs`
...
namespace Modules.Ocean.Renderer {
    ...
    public class FluxPagedLODRenderer : MonoBehaviour {
        ...
        public void UpdatePerFrameContexts(in Vector3 center,in Plane[] frustumPlanes) {
         ...
         //  Vector3 complementScale = new Vector3(0.5f, 0f, 0.5f);
            ...
            for (int i = 0; i < 4; i++) { 
                 ...
                 if (true || GeometryUtility.TestPlanesAABB(frustumPlanes, bounds) && !IsCulled(position,_PageCullingLevels[scaleLevel])) {
        ...
        private void DrawInstanced() {
            ...
            _blockLOD1.Clear();
            _blockLOD2.Clear();
           // _blockLOD0.SetVectorArray("_Mesh_pageStitchingMask", _pageStitchingMaskLOD0_Committed);
           // _blockLOD1.SetVectorArray("_Mesh_pageStitchingMask", _pageStitchingMaskLOD1_Committed);
           // _blockLOD2.SetVectorArray("_PageStitchingMask", _pageStitchingMaskLOD2_Committed);
            //Debug.Log($"{_matricesLOD0_Committed.Count}");
            Graphics.DrawMeshInstanced(fluxPlane_LOD0, 0,material , _matricesLOD0_Committed);
            Graphics.DrawMeshInstanced(fluxPlane_LOD1, 0,material , _matricesLOD1_Committed);
