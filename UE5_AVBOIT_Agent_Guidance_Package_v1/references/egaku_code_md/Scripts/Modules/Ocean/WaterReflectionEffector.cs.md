# Egaku source: `Scripts/Modules/Ocean/WaterReflectionEffector.cs`
...
namespace Modules.Ocean {
    ...
    public class WaterReflectionEffector : MonoBehaviour {
        ...
        private void RenderReflection(ScriptableRenderContext context, Camera renderCamera) {
         ...
         //   request.destination = _reflectionTexture;
        ...
        private void CreatePlanarReflectionTexture(Camera cam) {
            if (_reflectionTexture == null) {
                ...
                _reflectionTexture.name = "Planar Reflection Texture";
            }
        ...
        private void SyncCameraSettings(Camera src, Camera dest) {
          ...
          //  dest.CopyFrom(src);
            ...
            // once modified this attrib, unity won't derive it from transform.
        ...
        private Camera CreateReflectCamera() {
            ...
            if (gameObj == null) {
                ...
                cameraData.tag = "PlanarReflection";
